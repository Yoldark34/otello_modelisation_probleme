...
public class IhmScore extends RelativeLayout {
	...
	public IhmScore(Context aContext, AttributeSet aAttrs) {
		...
		LayoutParams tourParams = new LayoutParams(LayoutParams.WRAP_CONTENT,
		...
		LayoutParams noirParams = new LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		...
		LayoutParams blancParams = new LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
